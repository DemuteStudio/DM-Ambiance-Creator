...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawTriggerSettingsSection_OLD(dataObj, callbacks, width, titlePrefix, autoRegenCallback, isGroup, groupIndex, containerIndex)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.displayTriggerSettings_OLD(obj, objId, width, isGroup, groupIndex, containerIndex)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawFadeSettingsSection_OLD(obj, objId, width, titlePrefix, groupIndex, containerIndex)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawNoisePreview_OLD(dataObj, width, height)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawEuclideanPreview_OLD(dataObj, size, isGroup)
    -- Determine if we're in auto-bind mode
    local isAutoBind = isGroup and (dataObj.euclideanAutoBindContainers or false)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawEuclideanPatternPresetBrowser_OLD()
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.drawEuclideanSavedPatternsList_OLD(dataObj, callbacks, isGroup, groupIndex, containerIndex, height)
...
-- LEGACY IMPLEMENTATION BELOW - TO BE REMOVED AFTER VERIFICATION
--[[
function UI.ShowMainWindow_OLD(open)
